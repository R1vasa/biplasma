  ...
  return (
    <div className="">
        <div className="flex flex-col items-center justify-center mt-20 lg:mt-9">
            ...
            <h1 className="font-Starshines text-yellow-500 text-md font-extrabold mt-4 mx-4 text-center py-2 px-8 rounded-full bg-white/20 shadow-lg [-webkit-text-stroke:0.3px_white] z-1 bottom-20 lg:absolute md:text-2xl md:mx-0">Biology <span className="text-blue-500">Open</span> <span className="text-green-500">House</span> <span className="text-red-400">Olympiad </span> and <span className="text-blue-500">Saturday’s</span> <span className="text-purple-500">Market </span></h1>
